...
- **Chapter 6** – Greedy Algorithms (CP Handbook)
- **Chapter 7** – Dynamic Programming (CP Handbook)

> 🔺 **Advanced:** Also finish **Chapter 8** (Amortized Analysis) if not done, and read **Chapter 22** (Combinatorics) for the combinatorics DP problems below.
...
Solve in order — they're roughly increasing in concept complexity.
...
- [CSES DP Section](https://cses.fi/problemset/list/) (scroll to Dynamic Programming)
